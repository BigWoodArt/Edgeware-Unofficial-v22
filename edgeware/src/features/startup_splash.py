...
class StartupSplash(Toplevel):
    def __init__(self, settings: Settings, pack: Pack, callback: Callable[[], None]) -> None:
        ...
        # Same fix as Popup._reassert_topmost - see popup.py. This is the
        # window most likely to be the one you notice appearing behind other
        # windows, since it's the very first thing Edgeware shows right after
        # being launched from config.pyw.
    ...
    def _reassert_topmost(self) -> None:
        try:
            ...
            pass  # Splash was already closed before this ran
