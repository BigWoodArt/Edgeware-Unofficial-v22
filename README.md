...
never falls back to a generic placeholder wallpaper if you forgot to set one.
...
and visibility into which settings the selected pack overrides (with a "Priority"
toggle to decide who wins, you or the pack).
